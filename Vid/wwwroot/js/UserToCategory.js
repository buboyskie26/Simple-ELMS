...
$(function () {
    ...
    $('select').on('change', function () {
        ...
        var url = '/Admin/UsersToCategory/GetUsersFromCategory?categoryId=' + this.value;
        ...
        if (this.value != 0) {
            ...
            $("button[name='SaveSelectedUsers']").prop('disabled', true);
            $("input[name='usersSelected']").prop('disabled', true);

            $("input[name='usersSelected']").prop('checked', false);
        }
    ...
    $('#SaveSelectedUsers').click(function () {
        ...
        var url = "/Admin/UsersToCategory/SaveSelectedUsersFromCategory";
